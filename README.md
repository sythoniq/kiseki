...
1. Figure out how to set the user state for the sidebar so that I dont have to refresh the whole page so as to remount on login...

2. Same case as 1 but for the comments... need to allow for comment to be posted and shown on the page afterwards...
