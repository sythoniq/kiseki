...
posts.delete("/:postId/delete", auth.validateUser, auth.validateAdmin, controller.deletePost)
...
posts.post("/:postId/comment/:commentId", auth.validateUser, auth.validateAdmin, controller.deletePostComment)
